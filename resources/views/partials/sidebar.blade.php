@if (auth()->user()->role == 'ADMIN')
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
            ...
            <!-- Operator -->
            <li class="menu-item {{ is_route('operator.index', 'active') }}">
            ...
            <!-- Student -->
            <li class="menu-item {{ is_route('student.index', 'active') }}">
            ...
            <!-- Spp -->
            <li class="menu-item {{ is_route('spp.index', 'active') }}">
            ...
            <!-- History Payment -->
            <li class="menu-item {{ is_route('payment.index', 'active') }}">
